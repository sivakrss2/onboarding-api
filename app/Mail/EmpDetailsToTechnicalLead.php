...
class EmpDetailsToTechnicalLead extends Mailable
{
    ...
    {
        $template = $this->view('mail.emp_details_to_technical_lead')->with(['content' => $this->template_details['template_details']]);
